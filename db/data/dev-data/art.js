module.exports = [
  ...
  },
  {
    ...
    book_id: 4,
    made_from:
      "My second university trilogy. Main theme was obsessive madness, and this burning doll was a central image. This might have been a comment on the persecution of the mentally ill, or maybe I just hated that doll.",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  },
  {
    ...
    book_id: 4,
    made_from:
      "30cm by 42cm by 3.5cm boxed canvas, oil paint. A commission I was never paid for. I don't do commissions now, especially if they're this hippy nonsense. What even is this?",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  },
  {
    ...
    three_word_description: "yellow-butterfly-painting",
    custom_link: "",
  ...
  },
  {
    ...
    quote: "The parallel universe you access through your mindscape's extra dimension...",
    book_id: 3,
  ...
  },
  {
    ...
    art_title: "MS Charity Photoshoot by Ray Snell, Head Full of Photos, and Andy Harris",
  ...
  },
  {
    ...
    book_id: 3,
    made_from: "Amateur modelling as attempted self-esteem boost.",
    price: -1,
    self_ref: "TBC",
    close_ups: "8",
    is_close_up: false,
  ...
  {
    stock_id: "1203",
    art_title: "Happy Octopirate",
    three_word_description: "smiling-octopus-pirate",
    custom_link: "",
    colours: "white, grey",
    completion: "2017-06-14",
    subject: "creatures",
    category_id: 1,
    series_id: 2,
    alt_text: "Biro drawing of smiling octopus with pirate hat.",
    quote: "Loaded with purchases, Cal escorts his sister to the helpful cowboy's commune for artistic vagrants.",
    book_id: 3,
    made_from: "Biro on paper.",
    price: -1,
    self_ref: "TBC",
  ...
  },
  {
    ...
    book_id: 3,
    made_from: "Modelling with books, art and merch.",
    price: -1,
    self_ref: "TBC",
    close_ups: "5",
    is_close_up: false,
  ...
  },
  {
    ...
    category_id: 9,
    series_id: 13,
    alt_text: "Carlie Martece in Hell Flat One",
    ...
    book_id: 3,
    made_from: "Modelling in Hell Flat One",
    price: -1,
    self_ref: "TBC",
    close_ups: "4",
    is_close_up: false,
  ...
  {
    stock_id: "913-200704a",
    art_title: "Quarantina",
    three_word_description: "quarantine-pandemic-blues",
    custom_link: "",
    colours: "redblackwhite, red",
    completion: "2020-07-04",
    subject: "Carlie Martece",
    category_id: 9,
    series_id: 13,
    alt_text: "Attentions-seeking selfies following a pandemic breakup.",
    quote: "\"I'm euphoric today. Cameras must be my anti-depressant! ...It's a reason to wear red lipstick...\"",
    book_id: 3,
    made_from: "Modelling as light relief from Chroma: Calanooka editing",
    price: -1,
    self_ref: "TBC",
    close_ups: "8",
    is_close_up: false,
  ...
  },
  {
    ...
    custom_link: "",
    colours: "rainbow",
    completion: "2020-07-31",
    subject: "fantasy",
    category_id: 1,
    series_id: 11,
    alt_text: "Mushrooms before a rainbow eye in a strange land.",
    quote: "Godish historians say the original creators designed Chroma as a massive space rainbow, because they were gay.",
    book_id: 3,
    made_from: "Prismacolor pencils and black biro.",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  {
    stock_id: "1205",
    art_title: "Holliflies",
    three_word_description: "xmas-holly-butterflies",
    custom_link: "",
    colours: "green",
    completion: "2020-09-26",
    subject: "butterflies",
    category_id: 1,
    series_id: 2,
    alt_text: "Butterflies with berry bodies and holly leaf wings.",
    quote: "\"Butterflies began as caterpillars, not worms. And we need to leave.\"",
    book_id: 3,
    made_from: "Prismacolor pencils.",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  {
    stock_id: "1207",
    art_title: "Mister Chameleon",
    three_word_description: "smiling-chameleon-dude",
    custom_link: "",
    ...
    category_id: 1,
    series_id: 2,
    alt_text: "Biro drawing of happy chameleon.",
    quote: "Every wasted party rolled into one combined memory.",
    book_id: 6,
    made_from: "Black and red biro.",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  {
    stock_id: "1209",
    art_title: "Ms Crime Fox",
    three_word_description: "goth-biro-fox",
    custom_link: "",
    colours: "black, grey",
    completion: "2020-11-22",
    subject: "creatures",
    category_id: 1,
    series_id: 2,
    alt_text: "Biro drawing of grey fox.",
    quote: "The voices were coming from video chat, an online party. My friends were in my laptop. The DJ was in the television. We were simultaneously together and apart, and police helicopters were circling overhead, scanning for doubly illegal raves.",
    book_id: 6,
    made_from: "Black biro on white paper, against digital black.",
    price: -1,
    self_ref: "TBC",
    close_ups: "0",
    is_close_up: false,
  ...
  {
    stock_id: "1210",
    art_title: "Mister Robotino",
    three_word_description: "biro-robot-drawing",
    custom_link: "",
    colours: "grey",
    ...
    category_id: 1,
    series_id: 2,
    alt_text: "Biro drawing of smiling cartoon robot.",
    quote: "This wasn't even Day Zero. It was just another Saturday. By the time Day Zero arrived, time had disintegrated...",
    book_id: 6,
    made_from: "Black biro.",
    price: -1,
    self_ref: "TBC",
