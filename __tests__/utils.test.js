...
const art = [
    {
        ...
        'category_id': 3,
        'series_id': 1,
        'alt_text': 'Weird collage with dripping paint and disturbing childhood imagery.',
    ...
    },
    {
        ...
        'category_id': 1,
        'series_id': 3,
        'alt_text': 'Depressed fairy with no mouth holding flowers that look like grapes.',
...
describe('formatArt function', () => {
    ...
    test('Function changes close_ups count to stock_id array', () => {
        const actual = formatArt(art);
        const expected = '3001b,3001c,3001d,3001e,3001f,3001g'
        expect(actual[0].close_ups).toEqual(expected);
    });
});
